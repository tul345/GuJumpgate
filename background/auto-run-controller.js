        ...
        while (attemptRun <= maxAttemptsForRound) {
          ...
          if (!useExistingProgress) {
            ...
            const keepSettings = {
              ...
              hostedCheckoutVerificationPollBeforeResend: prevState.hostedCheckoutVerificationPollBeforeResend,
              hostedCheckoutVerificationResendMaxAttempts: prevState.hostedCheckoutVerificationResendMaxAttempts,
              hostedCheckoutVerificationAfterResendWaitSeconds: prevState.hostedCheckoutVerificationAfterResendWaitSeconds,
